...
const (
	...
	// If this flag is set, it tells gubernator that the client has already performed a consistent hash
	// calculation and is sure that the instance receiving this rate limit is the owner. No forwarding
	// of this rate limit will be done. (Currently only respected via the UpdateRateLimits() call)
	Behavior_HASH_COMPUTED Behavior = 9
	// If this flag is set, then even if a rate limit response is OVER_LIMIT the hits submitted will
	// count against the remaining.
	//
	// In the common case a client who requested more than is available will be denied access to the
	// resource that is rate limited, since the request will be denied the hits should not be subtracted
	// from the remaining. However in some cases it might be useful to the client to subtract the hits of
	// the denied request form the remaining. Setting this flag enables that behavior. NOTE: Even when
	// counting over the limit hits, the remaining should never be a negative number.
	Behavior_ALWAYS_COUNT_HITS Behavior = 10
)
...
type RateLimitReq struct {
	...
	// The name of the replica group this rate limit should be replicated too.
	// If empty no replication is performed.
	Replica string `protobuf:"bytes,9,opt,name=replica,proto3" json:"replica,omitempty"`
}
...
func (x *RateLimitReq) GetReplica() string {
	if x != nil {
		return x.Replica
	}
	return ""
...
var file_gubernator_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x52, 0x09, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x22, 0xa4, 0x02,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x62, 0x75, 0x72, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65,
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x65, 0x70,
	0x6c, 0x69, 0x63, 0x61, 0x22, 0xac, 0x02, 0x0a, 0x0d, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d,
	...
	,
}
