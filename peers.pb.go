...
type UpdateRateLimitsReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Must specify at least one RateLimit
	RateLimits []*RateLimitReq `protobuf:"bytes,1,rep,name=rate_limits,json=rateLimits,proto3" json:"rate_limits,omitempty"`
}

func (x *UpdateRateLimitsReq) Reset() {
	*x = UpdateRateLimitsReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateRateLimitsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateRateLimitsReq) ProtoMessage() {}

func (x *UpdateRateLimitsReq) ProtoReflect() protoreflect.Message {
	mi := &file_peers_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateRateLimitsReq.ProtoReflect.Descriptor instead.
func (*UpdateRateLimitsReq) Descriptor() ([]byte, []int) {
	return file_peers_proto_rawDescGZIP(), []int{5}
}

func (x *UpdateRateLimitsReq) GetRateLimits() []*RateLimitReq {
	if x != nil {
		return x.RateLimits
	}
	return nil
...
type UpdateRateLimitsResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *UpdateRateLimitsResp) Reset() {
	*x = UpdateRateLimitsResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateRateLimitsResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateRateLimitsResp) ProtoMessage() {}

func (x *UpdateRateLimitsResp) ProtoReflect() protoreflect.Message {
	mi := &file_peers_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateRateLimitsResp.ProtoReflect.Descriptor instead.
func (*UpdateRateLimitsResp) Descriptor() ([]byte, []int) {
...
var file_peers_proto_rawDesc = []byte{
	...
	,
}
...
var file_peers_proto_goTypes = []interface{}{
	...
	(*UpdateRateLimitsReq)(nil),   // 5: pb.gubernator.UpdateRateLimitsReq
	(*UpdateRateLimitsResp)(nil),  // 6: pb.gubernator.UpdateRateLimitsResp
	(*RateLimitReq)(nil),          // 7: pb.gubernator.RateLimitReq
	(*RateLimitResp)(nil),         // 8: pb.gubernator.RateLimitResp
	(Algorithm)(0),                // 9: pb.gubernator.Algorithm
}
var file_peers_proto_depIdxs = []int32{
	7, // 0: pb.gubernator.GetPeerRateLimitsReq.requests:type_name -> pb.gubernator.RateLimitReq
	8, // 1: pb.gubernator.GetPeerRateLimitsResp.rate_limits:type_name -> pb.gubernator.RateLimitResp
	3, // 2: pb.gubernator.UpdatePeerGlobalsReq.globals:type_name -> pb.gubernator.UpdatePeerGlobal
	8, // 3: pb.gubernator.UpdatePeerGlobal.status:type_name -> pb.gubernator.RateLimitResp
	9, // 4: pb.gubernator.UpdatePeerGlobal.algorithm:type_name -> pb.gubernator.Algorithm
	7, // 5: pb.gubernator.UpdateRateLimitsReq.rate_limits:type_name -> pb.gubernator.RateLimitReq
	0, // 6: pb.gubernator.PeersV1.GetPeerRateLimits:input_type -> pb.gubernator.GetPeerRateLimitsReq
	2, // 7: pb.gubernator.PeersV1.UpdatePeerGlobals:input_type -> pb.gubernator.UpdatePeerGlobalsReq
	5, // 8: pb.gubernator.PeersV1.UpdateRateLimits:input_type -> pb.gubernator.UpdateRateLimitsReq
	1, // 9: pb.gubernator.PeersV1.GetPeerRateLimits:output_type -> pb.gubernator.GetPeerRateLimitsResp
	4, // 10: pb.gubernator.PeersV1.UpdatePeerGlobals:output_type -> pb.gubernator.UpdatePeerGlobalsResp
	6, // 11: pb.gubernator.PeersV1.UpdateRateLimits:output_type -> pb.gubernator.UpdateRateLimitsResp
...
func file_peers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_peers_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateRateLimitsReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_peers_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateRateLimitsResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
